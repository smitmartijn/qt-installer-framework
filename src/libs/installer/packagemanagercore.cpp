...
/*!
    ...
    \inmodule QtInstallerFramework
    \brief The PackageManagerCore class provides the core functionality of the
...
/*!
    \fn QInstaller::PackageManagerCore::aboutCalculateComponentsToInstall()
   const

    \sa
   {installer::aboutCalculateComponentsToInstall}{installer.aboutCalculateComponentsToInstall}
*/

/*!
    \fn QInstaller::PackageManagerCore::finishedCalculateComponentsToInstall()
   const

    \sa
   {installer::finishedCalculateComponentsToInstall}{installer.finishedCalculateComponentsToInstall}
*/

/*!
    \fn QInstaller::PackageManagerCore::aboutCalculateComponentsToUninstall()
   const

    \sa
   {installer::aboutCalculateComponentsToUninstall}{installer.aboutCalculateComponentsToUninstall}
*/

/*!
    \fn QInstaller::PackageManagerCore::finishedCalculateComponentsToUninstall()
   const

    \sa
   {installer::finishedCalculateComponentsToUninstall}{installer.finishedCalculateComponentsToUninstall}
*/

/*!
    \fn QInstaller::PackageManagerCore::componentAdded(QInstaller::Component
   *comp)
...
/*!
    \fn
   QInstaller::PackageManagerCore::rootComponentsAdded(QList<QInstaller::Component*>
   components)

    Emitted when the list of root components specified by \a components is
   added.
...
/*!
    \fn
   QInstaller::PackageManagerCore::updaterComponentsAdded(QList<QInstaller::Component*>
   components)

    Emitted when a new list of updater components specified by \a components is
   added.
...
/*!
    \fn QInstaller::PackageManagerCore::valueChanged(const QString &key, const
   QString &value)
...
/*!
    \fn
   QInstaller::PackageManagerCore::defaultTranslationsLoadedForLanguage(QLocale::Language
   lang)
...
/*!
    \fn QInstaller::PackageManagerCore::metaJobInfoMessage(const QString
   &message)

    Triggered with informative updates, \a message, of the communication with a
   remote repository.
...
/*!
    \fn QInstaller::PackageManagerCore::finishAllComponentsReset(const
   QList<QInstaller::Component*> &rootComponents)

    Triggered when the list of new root components, \a rootComponents, has been
   updated.

    \sa
   {installer::finishAllComponentsReset}{installer.finishAllComponentsReset} \sa
...
/*!
    ...
    \sa
   {installer::startUpdaterComponentsReset}{installer.startUpdaterComponentsReset}
*/

/*!
    \fn QInstaller::PackageManagerCore::finishUpdaterComponentsReset(const
   QList<QInstaller::Component*> &componentsWithUpdates)

    Triggered when the list of available remote updates, \a
   componentsWithUpdates, has been updated.

    \sa
   {installer::finishUpdaterComponentsReset}{installer.finishUpdaterComponentsReset}
*/
...
/*!
    ...
    \sa
   {installer::offlineGenerationStarted()}{installer.offlineGenerationStarted()}
*/
...
/*!
    ...
    \sa
   {installer::offlineGenerationFinished()}{installer.offlineGenerationFinished()}
*/

/*!
    \fn QInstaller::PackageManagerCore::titleMessageChanged(const QString
   &title)

    Emitted when the text of the installer status (on the PerformInstallation
   page) changes to \a title.
...
/*!
    ...
    Emitted when all data archives for components have been downloaded
   successfully.

    \sa
   {installer::downloadArchivesFinished}{installer.downloadArchivesFinished}
*/

/*!
    \fn QInstaller::PackageManagerCore::wizardPageInsertionRequested(QWidget
   *widget, QInstaller::PackageManagerCore::WizardPage page)

    Emitted when a custom \a widget is about to be inserted into \a page by
    addWizardPage().

    \sa
   {installer::wizardPageInsertionRequested}{installer.wizardPageInsertionRequested}
*/

/*!
    \fn QInstaller::PackageManagerCore::wizardPageRemovalRequested(QWidget
   *widget)

    Emitted when a \a widget is removed by removeWizardPage().

    \sa
   {installer::wizardPageRemovalRequested}{installer.wizardPageRemovalRequested}
*/

/*!
    \fn QInstaller::PackageManagerCore::wizardWidgetInsertionRequested(QWidget
   *widget, QInstaller::PackageManagerCore::WizardPage page, int position)

    Emitted when a \a widget is inserted into \a page by addWizardPageItem(). If
   several widgets are added to the same \a page, widget with lower \a position
   number will be inserted on top.

    \sa
   {installer::wizardWidgetInsertionRequested}{installer.wizardWidgetInsertionRequested}
*/

/*!
    \fn QInstaller::PackageManagerCore::wizardWidgetRemovalRequested(QWidget
   *widget)

    Emitted when a \a widget is removed by removeWizardPageItem().

    \sa
   {installer::wizardWidgetRemovalRequested}{installer.wizardWidgetRemovalRequested}
*/

/*!
    \fn QInstaller::PackageManagerCore::wizardPageVisibilityChangeRequested(bool
   visible, int page)

    Emitted when the visibility of the page with the ID \a page changes to \a
   visible.

    \sa setDefaultPageVisible()
    \sa
   {installer::wizardPageVisibilityChangeRequested}{installer.wizardPageVisibilityChangeRequested}
*/

/*!
    \fn
   QInstaller::PackageManagerCore::setValidatorForCustomPageRequested(QInstaller::Component
   *component, const QString &name, const QString &callbackName)

    Requests that a validator be set for the custom page specified by \a name
   and \a callbackName for the component \a component. Triggered when
    setValidatorForCustomPage() is called.

    \sa
   {installer::setValidatorForCustomPageRequested}{installer.setValidatorForCustomPageRequested}
*/

/*!
    \fn QInstaller::PackageManagerCore::setAutomatedPageSwitchEnabled(bool
   request)

    Triggered when the automatic switching from the perform installation to the
   installation finished page is enabled (\a request is \c true) or disabled (\a
   request is \c false).

    The automatic switching is disabled automatically when for example the user
   expands or unexpands the \uicontrol Details section of the
   PerformInstallation page.

    \sa
   {installer::setAutomatedPageSwitchEnabled}{installer.setAutomatedPageSwitchEnabled}
*/
...
/*!
    ...
    \sa
   {installer::coreNetworkSettingsChanged}{installer.coreNetworkSettingsChanged}
*/
...
/*!
    \fn QInstaller::PackageManagerCore::unstableComponentFound(const QString
   &type, const QString &errorMessage, const QString &component)

    Emitted when an unstable \a component is found containing an unstable \a
   type and \a errorMessage.
*/

/*!
    \fn QInstaller::PackageManagerCore::installerBinaryMarkerChanged(qint64
   magicMarker)
...
static bool componentMatches(const Component *component, const QString &name,
  ...
  return PackageManagerCore::versionMatches(component->value(scVersion),
                                            version);
}
...
void PackageManagerCore::writeMaintenanceTool() {
  if (d->m_disableWriteMaintenanceTool) {
    qCDebug(QInstaller::lcInstallerInstallLog())
        << "Maintenance tool writing disabled.";
    return;
  }

  if (d->m_needToWriteMaintenanceTool) {
    try {
      d->writeMaintenanceTool(d->m_performedOperationsOld +
                              d->m_performedOperationsCurrentSession);
      ...
      MessageBoxHandler::critical(
          ...
          QLatin1String("WriteError"), tr("Error writing Maintenance Tool"),
          error.message(), QMessageBox::Ok, QMessageBox::Ok);
    }
  }
}
...
/*!
    Disables writing of maintenance tool for the current session if \a disable
   is \c true.
 */
...
*/
QObject *PackageManagerCore::guiObject() const { return d->m_guiObject; }

/*!
    Sets the uninstallation to be \a complete. If \a complete is false, only
   components deselected by the user will be uninstalled. This option applies
   only on uninstallation.

    \sa
   {installer::setCompleteUninstallation}{installer.setCompleteUninstallation}
 */
 ...
 */
void PackageManagerCore::cancelMetaInfoJob() { d->m_metadataJob.cancel(); }
 ...
 */
template <typename T>
bool PackageManagerCore::loadComponentScripts(const T &components,
                                              const bool postScript) {
  return d->loadComponentScripts(components, postScript);
}

template bool PackageManagerCore::loadComponentScripts<QList<Component *>>(
    const QList<Component *> &, const bool);
template bool
PackageManagerCore::loadComponentScripts<QHash<QString, Component *>>(
    const QHash<QString, Component *> &, const bool);

/*!
    \deprecated [4.5] Use recalculateAllComponents() instead.

    \sa
   {installer::componentsToInstallNeedsRecalculation}{installer.componentsToInstallNeedsRecalculation}
 */
...
/*!
    ...
    \deprecated [4.5] Installer framework recalculates components each time the
   calculation of components to install is requested, so there is no need to
   call this anymore, and the method does nothing. On previous versions calling
   this forced a recalculation of components to install.

    \sa
   {installer::clearComponentsToInstallCalculated}{installer.clearComponentsToInstallCalculated}
 */
...
/*!
    ...
    with {installer::componentsToInstallError} and
   {installer::componentsToUninstallError}.
 */
...
/*!
   Automatically closes the message box with the ID \a identifier as if the user
   had pressed \a button.

   This can be used for unattended (automatic) installations.

   \sa
   {installer::setMessageBoxAutomaticAnswer}{installer.setMessageBoxAutomaticAnswer}
   \sa QMessageBox, autoAcceptMessageBoxes(), autoRejectMessageBoxes()
 */
void PackageManagerCore::setMessageBoxAutomaticAnswer(const QString &identifier,
                                                      int button) {
  MessageBoxHandler::instance()->setAutomaticAnswer(
      identifier, static_cast<QMessageBox::Button>(button));
}
...
/*!
    Automatically accepts all license agreements required to install the
   selected components.
...
/*!
   Automatically sets the existing directory or filename \a value to QFileDialog
   with the ID \a identifier. QFileDialog can be called from script.

   This can be used for unattended (automatic) installations.

   \sa
   {installer::setFileDialogAutomaticAnswer}{installer.setFileDialogAutomaticAnswer}
 ...
 */
void PackageManagerCore::setFileDialogAutomaticAnswer(const QString &identifier,
                                                      const QString &value) {
...
/*!
   ...
   \sa
   {installer::removeFileDialogAutomaticAnswer}{installer.removeFileDialogAutomaticAnswer}
   \sa {QFileDialog::getExistingDirectory}{QFileDialog.getExistingDirectory}
   \sa {QFileDialog::getOpenFileName}{QFileDialog.getOpenFileName}
 */
void PackageManagerCore::removeFileDialogAutomaticAnswer(
    const QString &identifier) {
  m_fileDialogAutomaticAnswers.remove(identifier);
}

/*!
   Returns \c true if QFileDialog  with the ID \a identifier has an automatic
   answer set.

   \sa
   {installer::containsFileDialogAutomaticAnswer}{installer.containsFileDialogAutomaticAnswer}
   \sa
   {installer::removeFileDialogAutomaticAnswer}{installer.removeFileDialogAutomaticAnswer}
   \sa {QFileDialog::getExistingDirectory}{QFileDialog.getExistingDirectory}
   \sa {QFileDialog::getOpenFileName}{QFileDialog.getOpenFileName}
 */
bool PackageManagerCore::containsFileDialogAutomaticAnswer(
...
*/
quint64 PackageManagerCore::size(QInstaller::Component *component,
...
quint64 PackageManagerCore::requiredDiskSpace() const {
  ...
  foreach (QInstaller::Component *component, orderedComponentsToInstall())
    result += size(component, isOfflineGenerator() ? scCompressedSize
                                                   : scUncompressedSize);
...
/*!
   \sa
   {installer::requiredTemporaryDiskSpace}{installer.requiredTemporaryDiskSpace}
...
int PackageManagerCore::downloadNeededArchives(double partProgressSize) {
  ...
  foreach (Component *component, neededComponents) {
    ...
    bool checkSha1CheckSum =
        (component->value(scCheckSha1CheckSum).toLower() == scTrue);
    foreach (const QString &versionFreeString, toDownload) {
      DownloadItem item;
      item.checkSha1CheckSum = checkSha1CheckSum;
      item.fileName = scInstallerPrefixWithTwoArgs.arg(component->name(),
                                                       versionFreeString);
      item.sourceUrl = scThreeArgs.arg(component->repositoryUrl().toString(),
                                       component->name(), versionFreeString);
      archivesToDownload.push_back(item);
    }
    archivesToDownloadTotalSize +=
        component->value(scCompressedSize).toULongLong();
  }
  ...
  connect(this, &PackageManagerCore::installationInterrupted, &archivesJob,
          &Job::cancel);
  connect(&archivesJob, &DownloadArchivesJob::outputTextChanged,
          ProgressCoordinator::instance(),
          &ProgressCoordinator::emitLabelAndDetailTextChanged);
  connect(&archivesJob, &DownloadArchivesJob::downloadStatusChanged,
          ProgressCoordinator::instance(),
          &ProgressCoordinator::additionalProgressStatusChanged);

  connect(&archivesJob, &DownloadArchivesJob::fileDownloadReady, d,
          &PackageManagerCorePrivate::addPathForDeletion);
  connect(&archivesJob, &DownloadArchivesJob::hashDownloadReady, d,
          &PackageManagerCorePrivate::addPathForDeletion);

  ProgressCoordinator::instance()->registerPartProgress(
      &archivesJob, SIGNAL(progressChanged(double)), partProgressSize);
  ...
  ProgressCoordinator::instance()->emitAdditionalProgressStatus(
...
void PackageManagerCore::rollBackInstallation() {
  ...
  const int progressOperationCount =
      d->countProgressOperations(d->m_performedOperationsCurrentSession);
  const double progressOperationSize = double(1) / progressOperationCount;

  // reregister all the undo operations with the new size to the
  // ProgressCoordinator
  foreach (Operation *const operation, d->m_performedOperationsCurrentSession) {
    ...
    if (operationObject != nullptr) {
      ...
      if (mo->indexOfSignal(QMetaObject::normalizedSignature(
              "progressChanged(double)")) > -1) {
        ProgressCoordinator::instance()->registerPartProgress(
            operationObject, SIGNAL(progressChanged(double)),
            progressOperationSize);
      }
    }
  }
  ...
  while (!d->m_performedOperationsCurrentSession.isEmpty()) {
    try {
      Operation *const operation =
          d->m_performedOperationsCurrentSession.takeLast();
      const bool becameAdmin =
          !RemoteClient::instance().isActive() &&
          operation->value(QLatin1String("admin")).toBool() &&
          gainAdminRights();
      ...
      if (operation->value(QLatin1String("uninstall-only")).toBool() &&
        ...
        // We know the mkdir operation which is creating the target path. If we
        // do a full uninstall, prevent a forced remove of the full install path
        // including the target, instead try to remove the target only and only
        // if it is empty, otherwise fail silently. Note: this can only happen
        // if RemoveTargetDir is set, otherwise the operation does not exist at
        // all.
        operation->setValue(QLatin1String("forceremoval"), false);
      }

      PackageManagerCorePrivate::performOperationThreaded(operation,
                                                          Operation::Undo);

      const QString componentName =
          operation->value(QLatin1String("component")).toString();
      ...
      MessageBoxHandler::critical(
          MessageBoxHandler::currentBestSuitParent(),
          QLatin1String("ElevationError"), tr("Authentication Error"),
          tr("Some components "
             "could not be removed completely because administrative rights "
             "could not be acquired: %1.")
              .arg(e.message()));
    } catch (...) {
      MessageBoxHandler::critical(MessageBoxHandler::currentBestSuitParent(),
                                  QLatin1String("unknown"),
                                  tr("Unknown error."),
                                  tr("Some components could not be removed "
                                     "completely because an unknown "
                                     "error happened."));
    }
  }
}
...
/*!
    ...
    \sa
   {installer::isFileExtensionRegistered}{installer.isFileExtensionRegistered}
 */
bool PackageManagerCore::isFileExtensionRegistered(
    const QString &extension) const {
  QSettingsWrapper settings(QLatin1String("HKEY_CLASSES_ROOT"),
                            QSettings::NativeFormat);
  return settings.value(QString::fromLatin1(".%1/Default").arg(extension))
      .isValid();
}
...
/*!
    ...
    \note If the file does not exist or an error occurs while reading the file,
   an empty string is returned.

    \sa {installer::readFile}{installer.readFile}

 */
QString PackageManagerCore::readFile(const QString &filePath,
 ...
 *
 * \note Can be only called when installing from command line instance without
 * GUI. If the output device is not a TTY, i.e. when forwarding to a file, the
 * function will throw an error.
 *
 * \sa {installer::readConsoleLine}{installer.readConsoleLine}
 */
QString PackageManagerCore::readConsoleLine(const QString &title,
                                            qint64 maxlen) const {
...
/*!
    ...
    \list
        ...
        \li Returns \c false if the directory already exists and contains an
   installation. \li Returns \c false if the target is a file or a symbolic
   link. \li Returns \c true or \c false if the directory exists but is not
   empty, depending on the choice that the end users make in the displayed
   message box. \endlist
*/
bool PackageManagerCore::installationAllowedToDirectory(
  ...
  if (fi.isDir()) {
    ...
    if (fi2.exists()) {
      MessageBoxHandler::critical(
          MessageBoxHandler::currentBestSuitParent(),
          QLatin1String("TargetDirectoryInUse"), tr("Error"),
          tr("The directory you selected already "
             "exists and contains an installation. Choose a different target "
             "for installation."));
      return false;
    }

    QMessageBox::StandardButton bt = MessageBoxHandler::warning(
        MessageBoxHandler::currentBestSuitParent(),
        QLatin1String("OverwriteTargetDirectory"), tr("Warning"),
        tr("You have selected an existing, non-empty directory for "
           "installation.\nNote that it will be "
           "completely wiped on uninstallation of this application.\nIt is not "
           "advisable to install into "
    ...
    MessageBoxHandler::critical(
        ...
        tr("You have selected an existing file "
...
*/
QString
PackageManagerCore::targetDirWarning(const QString &targetDirectory) const {
    ...
    for (int i = 0; i < nativeTargetDir.length(); ++i) {
      if (nativeTargetDir.at(i).unicode() & 0xff80) {
        return tr("The path or installation directory contains non ASCII "
                  "characters. This "
                  "is currently not supported! Please choose a different path "
                  "or installation "
                  "directory.");
      }
    }
  ...
  if (!target.path().isEmpty() &&
      (target == QDir::root() || target == QDir::home())) {
    return tr("As the install directory is completely deleted, installing in "
              "%1 is forbidden.")
        .arg(QDir::toNativeSeparators(target.path()));
  }

#ifdef Q_OS_WIN
  // folder length (set by user) + maintenance tool name length (no extension) +
  // extra padding
  if ((nativeTargetDir.length() + settings().maintenanceToolName().length() +
       20) >= MAX_PATH) {
  ...
  if (nativeTargetDir.endsWith(QLatin1Char('.')))
    return tr("The installation path must not end with '.', please specify a "
              "valid directory.");
  ...
  static QRegularExpression ambCharRegEx(
      ambiguousChars, QRegularExpression::CaseInsensitiveOption);
...
PackageManagerCore::PackageManagerCore()
  ...
  Repository::registerMetaType(); // register, cause we stream the type as
                                  // QVariant
  qRegisterMetaType<QInstaller::PackageManagerCore::Status>(
      "QInstaller::PackageManagerCore::Status");
  qRegisterMetaType<QInstaller::PackageManagerCore::WizardPage>(
      "QInstaller::PackageManagerCore::WizardPage");
}

/*!
    Creates an installer or uninstaller and performs sanity checks on the
   operations specified by \a operations. A hash table of variables to be stored
   as package manager core values can be specified by \a params. Sets the
   current instance type to be either a GUI or CLI one based on the value of \a
   commandLineInstance.

    The magic marker \a magicmaker is a \c quint64 that identifies the type of
   the binary: \c installer or \c uninstaller.

    Creates and initializes a remote client. Requests administrator's rights for
    QFile, QSettings, and QProcess operations. Calls \c init() with \a
   socketName, \a key, and \a mode to set the server side authorization key.

    The \a datFileName contains the corresponding .dat file name for the running
    \c maintenance tool binary. \a datFileName can be empty if \c maintenance
   tool fails to find it or if \c installer is run instead of \c maintenance
   tool.
*/
PackageManagerCore::PackageManagerCore(qint64 magicmaker,
                                       ...
                                       const QString &key, Protocol::Mode mode,
                                       const QHash<QString, QString> &params,
                                       const bool commandLineInstance)
  ...
  // Creates and initializes a remote client, makes us get admin rights for
  // QFile, QSettings and QProcess operations. Init needs to called to set the
  // server side authorization key.
  if (!d->isUpdater()) {
    RemoteClient::instance().init(socketName, key, mode,
                                  Protocol::StartAs::SuperUser);
    RemoteClient::instance().setAuthorizationFallbackDisabled(
        settings().disableAuthorizationFallback());
  }
  ...
  //
  const QStringList localPackageList =
      d->m_core->localInstalledPackages().keys();
  QSet<QString> installedPackages(localPackageList.begin(),
                                  localPackageList.end());
  ...
  foreach (QInstaller::Operation *operation, d->m_performedOperationsOld) {
    if (operation->hasValue(QLatin1String("component")))
      operationPackages.insert(
          operation->value(QLatin1String("component")).toString());
  }

  QSet<QString> packagesWithoutOperation =
      installedPackages - operationPackages;
  ...
  if (!packagesWithoutOperation.isEmpty() || !orphanedOperations.isEmpty()) {
    qCritical() << "Operations missing for installed packages"
                << packagesWithoutOperation.values();
    qCritical() << "Orphaned operations" << orphanedOperations.values();
    qCritical() << "Your installation seems to be corrupted. Please consider "
                   "re-installing from scratch, "
                   "remove the packages from components.xml which operations "
                   "are missing, "
                   "or reinstall the packages.";
  } else {
    qCDebug(QInstaller::lcInstallerInstallLog)
        << "Operations sanity check succeeded.";
  }
  connect(this, &PackageManagerCore::metaJobProgress,
          ProgressCoordinator::instance(),
          &ProgressCoordinator::printProgressPercentage);
  connect(this, &PackageManagerCore::metaJobInfoMessage,
          ProgressCoordinator::instance(),
          &ProgressCoordinator::printProgressMessage);
}
...
PackageManagerCore::~PackageManagerCore() {
  if (!isUninstaller() &&
      !(isInstaller() && status() == PackageManagerCore::Canceled)) {
    QDir targetDir(value(scTargetDir));
    QString logFileName = targetDir.absoluteFilePath(value(
        QLatin1String("LogFileName"), QLatin1String("InstallationLog.txt")));
...
/*!
    ...
    file.
*/
bool PackageManagerCore::noForceInstallation() { return sNoForceInstallation; }

/* static */
/*!
    Overwrites the value specified for the component in the \c
   <ForcedInstallation> element in the package information file with \a value.
   This enables end users to select or deselect the component in the installer.
*/
...
bool PackageManagerCore::fetchLocalPackagesTree() {
  ...
  if (!isPackageManager()) {
    d->setStatus(Failure,
                 tr("Application not running in Package Manager mode."));
    return false;
  }
  ...
  loadLocalPackages = [&](QList<LocalPackage> *treeNamePackages,
                          bool firstRun) {
    foreach (auto &package,
             (firstRun ? installedPackages.values() : *treeNamePackages)) {
      ...
      QScopedPointer<QInstaller::Component> component(
          new QInstaller::Component(this));
      component->loadDataFromPackage(package);
      QString name = component->treeName();
      if (components.contains(name)) {
        qCritical() << "Cannot register component" << component->name()
                    << "with name" << name << "! Component with identifier"
                    << name << "already exists.";
        ...
        const QString errorString =
            QLatin1String("Tree name conflicts with an existing indentifier");
        d->m_pendingUnstableComponents.insert(
            component->name(), QPair<Component::UnstableError, QString>(
                                   Component::InvalidTreeName, errorString));
      }
...

  {
    ...
    // - and then components with tree names. This is to ensure components with
    // tree names do not replace other components when registering fails to a
    // name conflict.
...
/*!
    Returns a copy of the proxy factory that the package manager uses to
   determine the proxies to be used for requests.
*/
...
/*!
    Sets the proxy factory for the package manager to be \a factory. A proxy
   factory is used to determine a more specific list of proxies to be used for a
   given request, instead of trying to use the same proxy value for all
   requests. This might only be of use for HTTP or FTP requests.
*/
...
/*!
    Checks for compressed packages to install. Returns \c true if newer versions
   exist and they can be installed.
*/
...
bool PackageManagerCore::fetchPackagesTree(
    const PackagesList &packages, const LocalPackagesMap installedPackages) {
  ...
  if (!isUpdater()) {
    ...
    if (success && isPackageManager()) {
      foreach (Package *const update, packages) {
        bool essentialUpdate =
            (update->data(scEssential, scFalse).toString().toLower() == scTrue);
        bool forcedUpdate =
            (update->data(scForcedUpdate, scFalse).toString().toLower() ==
             scTrue);
        if (essentialUpdate || forcedUpdate) {
          ...
          if (localPackage.lastUpdateDate >= updateDate)
            continue; // remote release date equals or is less than the
                      // installed maintenance tool

          success = false;
          break; // we found a newer version of the forced/essential update
                 // package
        }
      }
      ...
      if (!success && !d->statusCanceledOrFailed()) {
        ...
        d->setStatus(
            ForceUpdate,
            tr("There is an important update available, please run the "
               "updater first."));
        return false;
      }
    }
...
/*!
    \fn QInstaller::PackageManagerCore::addWizardPage(QInstaller::Component *
   component, const QString & name, int page)

    Adds the widget with object name \a name registered by \a component as a new
   page into the installer's GUI wizard. The widget is added before \a page.
...
*/
bool PackageManagerCore::addWizardPage(Component *component,
                                       const QString &name, int page) {
  if (!isCommandLineInstance()) {
    ...
    qCDebug(QInstaller::lcDeveloperBuild)
        << "Headless installation: skip wizard page addition: " << name;
  }
  return false;
}

/*!
    \fn QInstaller::PackageManagerCore::removeWizardPage(QInstaller::Component *
   component, const QString & name)

    Removes the widget with the object name \a name previously added to the
   installer's wizard by \a component.
...
*/
bool PackageManagerCore::removeWizardPage(Component *component,
                                          const QString &name) {
  if (!isCommandLineInstance()) {
    if (QWidget *const widget = component->userInterface(name)) {
    ...
    qCDebug(QInstaller::lcDeveloperBuild)
        << "Headless installation: skip wizard page removal: " << name;
  }
  return false;
}

/*!
    Sets the visibility of the default page with the ID \a page to \a visible.
   That is, removes it from or adds it to the wizard. This works only for pages
   that were in the installer when it was started.
...
/*!
    \fn
   QInstaller::PackageManagerCore::setValidatorForCustomPage(QInstaller::Component
   * component, const QString & name, const QString & callbackName)

    Sets a validator for the custom page specified by \a name and \a
   callbackName for the component \a component.

    When using this, \a name has to match a dynamic page starting with \c
   Dynamic. For example, if the page is called DynamicReadyToInstallWidget, then
   \a name should be set to \c ReadyToInstallWidget. The \a callbackName should
   be set to a function that returns a boolean. When the \c Next button is
   pressed on the custom page, then it will call the \a callbackName function.
   If this returns \c true, then it will move to the next page.

    \sa
   {installer::setValidatorForCustomPage}{installer.setValidatorForCustomPage}
    \sa setValidatorForCustomPageRequested()
 */
void PackageManagerCore::setValidatorForCustomPage(
...
/*!
    \fn QInstaller::PackageManagerCore::addWizardPageItem(QInstaller::Component
   * component, const QString & name, int page, int position)

    Adds the widget with the object name \a name registered by \a component as a
   GUI element into the installer's GUI wizard. The widget is added on \a page
   ordered by \a position number. If several widgets are added to the same page,
   the widget with lower \a position number will be inserted on top.

    See \l{Controller Scripting} for the possible values of \a page.

    If the widget can be found in an UI file for the component, returns \c true
...
*/
bool PackageManagerCore::addWizardPageItem(Component *component,
                                           const QString &name, int page,
                                           int position) {
  if (!isCommandLineInstance()) {
    if (QWidget *const widget = component->userInterface(name)) {
    ...
    qCDebug(QInstaller::lcDeveloperBuild)
        << "Headless installation: skip wizard page item addition: " << name;
  }
  return false;
}
...
/*!
    \fn
   QInstaller::PackageManagerCore::removeWizardPageItem(QInstaller::Component *
   component, const QString & name)
...
*/
bool PackageManagerCore::removeWizardPageItem(Component *component,
                                              const QString &name) {
  if (!isCommandLineInstance()) {
    if (QWidget *const widget = component->userInterface(name)) {
...
/*!
    Sets additional \a repositories for this instance of the installer or
   updater if \a replace is \c false. \a compressed repositories can be added as
   well. Will be removed after invoking it again.

    \sa
   {installer::setTemporaryRepositories}{installer.setTemporaryRepositories} \sa
   addUserRepositories()
*/
void PackageManagerCore::setTemporaryRepositories(
    const QStringList &repositories, bool replace, bool compressed) {
  QSet<Repository> repositorySet;
  foreach (const QString &repository, repositories)
...
/*!
    Returns a list of components depending on the component types passed in \a
   mask. Optionally, a \a regexp expression can be used to further filter the
   listed packages.
*/
QList<Component *> PackageManagerCore::components(ComponentTypes mask,
  ...
  if (mask.testFlag(ComponentType::Replacements))
    components += updater ? d->m_updaterDependencyReplacements
                          : d->m_rootDependencyReplacements;
  ...
  if (!updater) {
    ...
    // No descendants here, updates are always a flat list and cannot have
    // children!
  }
...
/*!
    Returns a component matching \a name. \a name can also contain a version
   requirement. For example, \c org.qt-project.sdk.qt returns any component with
   that name, whereas \c{org.qt-project.sdk.qt->=4.5} requires the returned
   component to have at least version 4.5. If no component matches the
...
Component *PackageManagerCore::componentByName(const QString &name) const {
  ...
  if (d->m_componentByNameHash.isEmpty()) {
    ...
    const QList<Component *> componentsList =
        components(ComponentType::AllNoReplacements);
...
/*!
    ...
    \a name can also contain a version requirement. For example, \c
   org.qt-project.sdk.qt returns any component with that name, whereas
   \c{org.qt-project.sdk.qt->=4.5} requires the returned component to have at
   least version 4.5. If no component matches the requirement, \c 0 is returned.
*/
Component *
PackageManagerCore::componentByName(const QString &name,
...
QList<Component *> PackageManagerCore::componentsMarkedForInstallation() const {
  ...
  const QList<Component *> relevant =
      components(ComponentType::Root | ComponentType::Descendants);
  if (isUpdater()) {
...
/*!
    Determines which components to install based on the current run mode,
   including dependencies and automatic dependencies. Returns \c true on
   success, \c false otherwise.
    ...
    \sa
   {installer::calculateComponentsToInstall}{installer.calculateComponentsToInstall}
...
bool PackageManagerCore::calculateComponentsToInstall() const {
  ...
  const QList<Component *> selectedComponentsToInstall =
...
QString PackageManagerCore::componentResolveReasons() const {
  ...
  if (!componentsToInstallError().isEmpty()) {
    htmlOutput.append(
        QString::fromLatin1("<h2><font color=\"red\">%1</font></h2><ul>")
            .arg(tr("Cannot resolve all dependencies.")));
    // if we have a missing dependency or a recursion we can display it
    htmlOutput.append(
        QString::fromLatin1("<li> %1 </li>").arg(componentsToInstallError()));
  ...
  if (!componentsToUninstallError().isEmpty()) {
    ...
    htmlOutput.append(
        QString::fromLatin1("<li> %1 </li>").arg(componentsToUninstallError()));
    htmlOutput.append(QLatin1String("</ul>"));
    return htmlOutput;
  }
  ...
  if (!componentsToRemove.isEmpty()) {
    ...
    htmlOutput.append(QString::fromLatin1("<h3>%1</h3><ul>")
                          .arg(tr("Components about to "
                                  "be removed:")));
    ...
    for (auto &reason : orderedUninstallReasons.keys()) {
      ...
      foreach (const QString componentName,
               orderedUninstallReasons.value(reason))
        htmlOutput.append(
            QString::fromLatin1("<li> %1 </li>").arg(componentName));
      htmlOutput.append(QLatin1String("</ul>"));
    }
    htmlOutput.append(QLatin1String("</ul>"));
  }
  ...
  foreach (Component *component, orderedComponentsToInstall()) {
    ...
    if (lastInstallReason != reason) {
      if (!lastInstallReason
               .isEmpty()) // means we had to close the previous list
        htmlOutput.append(QLatin1String("</ul>"));
      htmlOutput.append(QString::fromLatin1("<h3>%1</h3><ul>").arg(reason));
      lastInstallReason = reason;
    }
    htmlOutput.append(
        QString::fromLatin1("<li> %1 </li>").arg(component->name()));
  }
  return htmlOutput;
}
...
/*!
    ...
    before the calculation starts, the finishedCalculateComponentsToUninstall()
   signal once all calculations are done. Returns \c true on success, \c false
   otherwise.

    \sa
   {installer::calculateComponentsToUninstall}{installer.calculateComponentsToUninstall}
*/
bool PackageManagerCore::calculateComponentsToUninstall() const {
  ...
  const QList<Component *> componentsToInstallList =
      d->installerCalculator()->resolvedComponents();

  QList<Component *> selectedComponentsToUninstall;
  foreach (Component *component,
           components(PackageManagerCore::ComponentType::Replacements)) {
    // Uninstall the component if replacement is selected for install or update
    QPair<Component *, Component *> comp =
        d->componentsToReplace().value(component->name());
    if (comp.first &&
        d->m_installerCalculator->resolvedComponents().contains(comp.first)) {
      d->uninstallerCalculator()->insertResolution(
          component, CalculatorBase::Resolution::Replaced, comp.first->name());
      selectedComponentsToUninstall.append(comp.second);
    }
  }
  foreach (Component *component,
           components(PackageManagerCore::ComponentType::AllNoReplacements)) {
    if (component->uninstallationRequested() &&
        !componentsToInstallList.contains(component))
...
*/
QList<Component *>
PackageManagerCore::dependees(const Component *_component) const {
  if (!_component)
    return QList<Component *>();

  const QList<QInstaller::Component *> availableComponents =
...
*/
bool PackageManagerCore::isDependencyForRequestedComponent(
  ...
  for (Component *availableComponent : availableComponents) {
    ...
    // 2. If component is selected and not installed, check if the dependency is
    // needed
...
*/
QStringList PackageManagerCore::localDependenciesToComponent(
    const Component *component) const {
  if (!component)
    return QStringList();
  ...
  QMap<QString, LocalPackage> localPackages =
      d->m_localPackageHub->localPackages();
...
ComponentModel *PackageManagerCore::defaultComponentModel() const {
  ...
  connect(this, &PackageManagerCore::finishAllComponentsReset,
          d->m_defaultModel, &ComponentModel::reset);
...
ComponentModel *PackageManagerCore::updaterComponentModel() const {
  ...
  connect(this, &PackageManagerCore::finishUpdaterComponentsReset,
          d->m_updaterModel, &ComponentModel::reset);
...
*/
void PackageManagerCore::listAvailablePackages(
    const QString &regexp, const QHash<QString, QString> &filters) {
  setPackageViewer();
  qCDebug(QInstaller::lcInstallerInstallLog)
  ...
  foreach (Package *package, packages) {
    ...
    const QModelIndex &idx =
        model->indexFromComponentName(component->treeName());
    if (idx.isValid() && re.match(name).hasMatch()) {
      ...
      for (auto &key : filters.keys()) {
        ...
        elementRegexp.setPatternOptions(
            QRegularExpression::CaseInsensitiveOption);
        if (elementValue.isEmpty() ||
            !elementRegexp.match(elementValue).hasMatch()) {
  ...
  if (matchedPackages.count() == 0)
    ...
    LoggingHandler::instance().printPackageInformation(
        matchedPackages, localInstalledPackages());
}

bool PackageManagerCore::componentUninstallableFromCommandLine(
    const QString &componentName) {
  ...
  if (model->data(idx, Qt::CheckStateRole) == QVariant::Invalid) {
    ...
    if (component->forcedInstallation()) {
      qCWarning(QInstaller::lcInstallerInstallLog).noquote().nospace()
          << "Cannot uninstall ForcedInstallation component "
          << component->name();
    } else if (component->autoDependencies().count() > 0) {
      qCWarning(QInstaller::lcInstallerInstallLog).noquote().nospace()
          << "Cannot uninstall component " << componentName
          << " because it is added as auto dependency to "
...
/*!
   ...
   in the default component model. Returns \c true if \a components contains at
   least one component eligible for installation, otherwise returns \c false. An
   error message can be retrieved with \a errorMessage.
*/
bool PackageManagerCore::checkComponentsForInstallation(
    const QStringList &components, QString &errorMessage) {
  ...
  foreach (const QString &name, components) {
    ...
    if (!component) {
      errorMessage.append(
          tr("Cannot install %1. Component not found.").arg(name) +
          QLatin1Char('\n'));
      continue;
    }
    const QModelIndex &idx =
    ...
    if (idx.isValid()) {
      if ((model->data(idx, Qt::CheckStateRole) == QVariant::Invalid) &&
        ...
        if (component->autoDependencies().count() > 0) {
          errorMessage.append(tr("Cannot install component %1. Component is "
                                 "installed only as automatic "
                                 "dependency to %2.")
                                  .arg(name, component->autoDependencies().join(
                                                 QLatin1Char(','))) +
                              QLatin1Char('\n'));
        } else if (!component->isCheckable()) {
          errorMessage.append(tr("Cannot install component %1. Component is "
                                 "not checkable, meaning you "
                                 "have to select one of the subcomponents.")
                                  .arg(name) +
                              QLatin1Char('\n'));
        } else if (component->isUnstable()) {
          errorMessage.append(
              tr("Cannot install component %1. There was a problem loading "
                 "this component, "
        ...
        errorMessage.append(tr("Component %1 already installed").arg(name) +
                            QLatin1Char('\n'));
      } else {
      ...
      auto isDescendantOfVirtual = [&]() {
        ...
        forever {
          ...
          if (!trace) {
            ...
            errorMessage.append(
                tr("Cannot install %1. Component is a descendant "
      ...
      // idx is invalid and component valid when we have invisible virtual
      // component
      if (component->isVirtual())
        errorMessage.append(
            tr("Cannot install %1. Component is virtual.").arg(name) +
            QLatin1Char('\n'));
...
/*!
    Lists installed packages without GUI. List of packages can be filtered with
   \a regexp.
*/
...
*/
PackageManagerCore::Status PackageManagerCore::updateComponentsSilently(
    const QStringList &componentsToUpdate) {
  ...
  // List contains components containing update, if essential found contains
  // only essential component
  const QList<QInstaller::Component *> componentList =
      componentsMarkedForInstallation();
  ...
  if (componentList.count() == 0) {
    ...
    // Check if essential components are available (essential components are
    // disabled). If essential components are found, update first essential
    // updates, restart installer and install rest of the updates.
    ...
    if (!essentialUpdatesFound) {
      ...
      foreach (Component *comp, componentList) {
        const QModelIndex &idx =
            model->indexFromComponentName(comp->treeName());
      ...
      foreach (Component *componentToUpdate, componentsToBeUpdated) {
        const QModelIndex &idx =
            model->indexFromComponentName(componentToUpdate->treeName());
        model->setData(idx, Qt::Checked, Qt::CheckStateRole);
      }
    }
    ...
    if (essentialUpdatesFound) {
      qCDebug(QInstaller::lcInstallerInstallLog)
          << "Essential components updated successfully."
 ...
 */
void PackageManagerCore::clearLicenses() { d->m_licenseItems.clear(); }
...
QHash<QString, QMap<QString, QString>> PackageManagerCore::sortedLicenses() {
  ...
  for (QString licenseName : d->m_licenseItems.keys()) {
    ...
    QString priority = d->m_licenseItems.value(licenseName)
                           .value(QLatin1String("priority"))
                           .toString();
    licenses = priorityHash.value(priority);
    licenses.insert(licenseName, d->m_licenseItems.value(licenseName)
...
/*!
 * Adds new set of \a licenses. If a license with the key already exists, it is
 * not added again.
 */
void PackageManagerCore::addLicenseItem(
    const QHash<QString, QVariantMap> &licenses) {
...
/*!
 * Adds \a component local \a dependencies to a hash table for quicker search
 * for uninstall dependency components.
 */
void PackageManagerCore::createLocalDependencyHash(
    const QString &component, const QString &dependencies) const {
 ...
 */
void PackageManagerCore::createAutoDependencyHash(
    const QString &component, const QString &oldDependencies,
    const QString &newDependencies) const {
...
/*!
    ...
    Returns PackageManagerCore installation status.
*/
PackageManagerCore::Status
PackageManagerCore::uninstallComponentsSilently(const QStringList &components) {
  if (d->runningProcessesFound())
    throw Error(tr("Running processes found."));
  ...
  foreach (const QString &componentName, components) {
    ...
    if (component) {
      ...
      qCWarning(QInstaller::lcInstallerInstallLog).noquote().nospace()
          << "Cannot uninstall component " << componentName
          << ". Component not found in install tree.";
    }
  }
  ...
  if (uninstallComponentFound) {
    if (d->calculateComponentsAndRun())
      qCDebug(QInstaller::lcInstallerInstallLog)
          << "Components uninstalled successfully";
  }
  return status();
}
...
PackageManagerCore::Status PackageManagerCore::removeInstallationSilently() {
  ...
  qCDebug(QInstaller::lcInstallerInstallLog)
      << "Complete uninstallation was chosen.";
...
/*!
    Creates an offline installer from selected \a componentsToAdd without
   displaying a user interface. Virtual components cannot be selected unless
   made visible with
    --show-virtual-components as in installation. AutoDependOn nor non-checkable
   components cannot be selected directly. Returns \c
   PackageManagerCore::Status.
*/
PackageManagerCore::Status
PackageManagerCore::createOfflineInstaller(const QStringList &componentsToAdd) {
  setOfflineGenerator();
...
*/
PackageManagerCore::Status
PackageManagerCore::installSelectedComponentsSilently(
    const QStringList &components) {
  if (!isInstaller()) {
    // Check if there are processes running in the install if maintenancetool is
    // used.
    if (d->runningProcessesFound())
      throw Error(tr("Running processes found."));
    setPackageManager();
  ...
  if (checkComponentsForInstallation(components, errorMessage)) {
    ...
    qCDebug(QInstaller::lcInstallerInstallLog).noquote().nospace()
        << errorMessage
        << "\nNo components available for installation with the current "
           "selection.";
  }
  return status();
}
...
*/
PackageManagerCore::Status
PackageManagerCore::installDefaultComponentsSilently() {
  ...
  if (!(model->checkedState() & ComponentModel::AllUnchecked)) {
    ...
    qCDebug(QInstaller::lcInstallerInstallLog)
        << "No components available for default installation.";
    setCanceled();
  }
  return status();
}
...
*/
Settings &PackageManagerCore::settings() const { return d->m_data.settings(); }
...
bool PackageManagerCore::gainAdminRights() {
  ...
  if (isCommandLineInstance()) {
    throw Error(
        tr("Cannot elevate access rights while running from command line. "
...
/*!
    Checks available disk space if the feature is not explicitly disabled.
   Informative text about space status can be retrieved by passing \a message
   parameter. Returns \c true if there is sufficient free space on installation
...
bool PackageManagerCore::checkAvailableSpace(QString &message) const {
  ...
  qDebug() << "Installation space required:" << humanReadableSize(required)
           ...
           << "Local repository size:" << humanReadableSize(repositorySize);

  if (d->m_checkAvailableSpace) {
    const VolumeInfo cacheVolume =
        VolumeInfo::fromPath(settings().localCachePath());
    ...
    if (targetVolume.size() == 0 && installVolumeAvailableSize == 0) {
      qDebug().nospace() << "Cannot determine available space on device. "
                            "Volume descriptor: "
                         << targetVolume.volumeDescriptor()
                         << ", Mount path: " << targetVolume.mountPath()
                         << ". Continue silently.";
      return true;
    }
    ...
    if (cacheOnSameVolume) {
      qDebug() << "Cache and install directories are on the same volume. "
                  "Volume mount point:"
               << targetVolume.mountPath() << "Free space available:"
               << humanReadableSize(installVolumeAvailableSize);
    } else {
      qDebug() << "Cache is on a different volume than the installation "
                  "directory. Cache volume mount point:"
               << cacheVolume.mountPath() << "Free space available:"
               << humanReadableSize(cacheVolumeAvailableSize)
               << "Install volume mount point:" << targetVolume.mountPath()
               << "Free space available:"
               << humanReadableSize(installVolumeAvailableSize);
    }

    if (cacheOnSameVolume &&
        (installVolumeAvailableSize <= (required + tempRequired))) {
      message = tr("Not enough disk space to store temporary files and the "
                   "installation. %1 are available, while the minimum required "
                   "is %2.")
    ...
    if (installVolumeAvailableSize < required) {
      message =
          tr("Not enough disk space to store all selected components! %1 are "
             "available, while the minimum required is %2.")
              .arg(humanReadableSize(installVolumeAvailableSize),
    ...
    if (cacheVolumeAvailableSize < tempRequired) {
      message = tr("Not enough disk space to store temporary files! %1 are "
                   "available, "
                   "while the minimum required is %2. You may select another "
                   "location for the "
                   "temporary files by modifying the local cache path from the "
                   "installer settings.")
                    .arg(humanReadableSize(cacheVolumeAvailableSize),
                         humanReadableSize(tempRequired));
      return false;
    }
    ...
    if (installVolumeAvailableSize - required < 0.01 * targetVolume.size()) {
      ...
      message = tr("The volume you selected for installation seems to have "
                   "sufficient space for "
                   "installation, but there will be less than 1% of the "
                   "volume's space available afterwards.");
    } else if (installVolumeAvailableSize - required < 100 * 1024 * 1024LL) {
      // warn for less than 100MB being free
      message = tr(
          "The volume you selected for installation seems to have sufficient "
          "space for installation, but there will be less than 100 MB "
          "available afterwards.");
    }
#ifdef Q_OS_WIN
    if (isOfflineGenerator() && (required > UINT_MAX)) {
      message =
          tr("The estimated installer size %1 would exceed the supported "
             "executable "
  ...
  message = QString::fromLatin1("%1 %2")
                .arg(message, tr("Installation will use %1 of disk space.")
                                  .arg(humanReadableSize(requiredDiskSpace())))
                .simplified();
...
/*!
    Returns \c true if a process with \a name is running. On Windows, the
...
/*!
    ...
    \note This is implemented in a semi blocking way (to keep the main thread to
   paint the UI).
...
bool PackageManagerCore::killProcess(const QString &absoluteFilePath) const {
  ...
  foreach (const ProcessInfo &process, allProcesses) {
    ...
    processPath = QDir::cleanPath(
        processPath.replace(QLatin1Char('\\'), QLatin1Char('/')));

    if (processPath == normalizedPath) {
      qCDebug(QInstaller::lcInstallerInstallLog).nospace()
          << "try to kill process " << process.name << " (" << process.id
          << ")";

      // to keep the ui responsible use QtConcurrent::run
      QFutureWatcher<bool> futureWatcher;
      const QFuture<bool> future =
          QtConcurrent::run(KDUpdater::killProcess, process, 30000);

      QEventLoop loop;
      connect(&futureWatcher, &QFutureWatcher<bool>::finished, &loop,
...
/*!
    ...
    \sa
   {installer::setAllowedRunningProcesses}{installer.setAllowedRunningProcesses}
*/
void PackageManagerCore::setAllowedRunningProcesses(
...
/*!
    Makes sure the installer runs from a local drive. Otherwise the user will
   get an appropriate error message.

    \note This only works on Windows.

    \sa
   {installer::setDependsOnLocalInstallerBinary}{installer.setDependsOnLocalInstallerBinary}
...
/*!
    Returns \c false if the installer is run on Windows, and the installer has
   been started from a remote file system drive. Otherwise returns \c true.

    \sa
   {installer::localInstallerBinaryUsed}{installer.localInstallerBinaryUsed} \sa
   setDependsOnLocalInstallerBinary()
*/
...
/*!
    ...
    \a stdInCodec is the name of the codec to use for converting the input
   string into bytes to write to the standard input of the application.

    \a stdOutCodec is the name of the codec to use for converting data written
   by the application to standard output into a string.
    ...
    \sa executeDetached()
*/
QList<QVariant> PackageManagerCore::execute(const QString &program,
                                            const QStringList &arguments,
                                            const QString &stdIn,
                                            const QString &stdInCodec,
                                            const QString &stdOutCodec) const {
  ...
  process.start(adjustedProgram, adjustedArguments,
                adjustedStdIn.isNull() ? QIODevice::ReadOnly
                                       : QIODevice::ReadWrite);
  ...
  if (!codec)
    return QList<QVariant>();
  return QList<QVariant>() << QTextDecoder(codec).toUnicode(
...
bool PackageManagerCore::executeDetached(
  ...
  foreach (const QString &argument, arguments)
    adjustedArguments.append(replaceVariables(argument));
  qCDebug(QInstaller::lcInstallerInstallLog)
      << "run application as detached process:" << adjustedProgram
...
/*!
    Returns the content of the environment variable \a name. An empty string is
...
QString PackageManagerCore::environmentVariable(const QString &name) const {
  ...
  if (value.isEmpty()) {
    static QLatin1String userEnvironmentRegistryPath(
        "HKEY_CURRENT_USER\\Environment");
    value = QSettings(userEnvironmentRegistryPath, QSettings::NativeFormat)
                .value(name)
                .toString();
    if (value.isEmpty()) {
      static QLatin1String systemEnvironmentRegistryPath(
          "HKEY_LOCAL_MACHINE\\SYSTEM\\"
          "CurrentControlSet\\Control\\Session Manager\\Environment");
      value = QSettings(systemEnvironmentRegistryPath, QSettings::NativeFormat)
                  .value(name)
                  .toString();
    }
  }
...
*/
bool PackageManagerCore::performOperation(const QString &name,
                                          const QStringList &arguments) {
  QScopedPointer<Operation> op(
      KDUpdater::UpdateOperationFactory::instance().create(name, this));
  if (!op.data())
    return false;
  ...
  if (!PackageManagerCorePrivate::performOperationThreaded(op.data())) {
    PackageManagerCorePrivate::performOperationThreaded(op.data(),
                                                        Operation::Undo);
    return false;
  }
  return true;
...
/*!
    ...
    \a requirement can be a fixed version number or it can be prefixed by the
   comparators '>', '>=',
    '<', '<=' and '='.

    \sa {installer::versionMatches}{installer.versionMatches}
*/
bool PackageManagerCore::versionMatches(const QString &version,
  ...
  const QString comparator =
      match.hasMatch() ? match.captured(1) : QLatin1String("=");
...
/*!
    ...
    \sa findPath()
*/
QString PackageManagerCore::findLibrary(const QString &name,
  ...
  const QString dynamic =
      findPath(QString::fromLatin1("lib%1.dylib").arg(name), findPaths);
#else
  if (findPaths.isEmpty()) {
    findPaths.push_back(QLatin1String("/lib"));
    findPaths.push_back(QLatin1String("/usr/lib"));
  ...
  const QString dynamic =
      findPath(QString::fromLatin1("lib%1.so*").arg(name), findPaths);
#endif
  if (!dynamic.isEmpty())
    return dynamic;
...
/*!
    Tries to find the file name \a name in one of the paths specified by \a
   paths. The resulting path is returned.
    ...
    \sa findLibrary()
*/
QString PackageManagerCore::findPath(const QString &name,
                                     const QStringList &paths) {
  foreach (const QString &path, paths) {
    const QDir dir(path);
    const QStringList entries =
        dir.entryList(QStringList() << name, QDir::Files | QDir::Hidden);
    if (entries.isEmpty())
      continue;
...
/*!
    ...
    If the path is not set, the executable segment of the running installer or
   uninstaller will be used.
...
/*!
    Sets the \c installerbase binary located at \a path to use when writing the
    offline installer. Setting this makes it possible to run the offline
   generator in cases where we are not running a real installer, i.e. when
   executing autotests.

    For normal runs, the executable segment of the running installer will be
   used.
*/
...
*/
void PackageManagerCore::addResourcesForOfflineGeneration(
    const QString &rcPath) {
  d->m_offlineGeneratorResourceCollections.append(rcPath);
}

/*!
    Returns the installer value for \a key. If \a key is not known to the
   system, \a defaultValue is returned. Additionally, on Windows, \a key can be
   a registry key. Optionally, you can specify the \a format of the registry
   key. By default the \a format is QSettings::NativeFormat. For accessing the
   32-bit system registry from a 64-bit application running on 64-bit Windows,
    use QSettings::Registry32Format. For accessing the 64-bit system registry
   from a 32-bit application running on 64-bit Windows, use
   QSettings::Registry64Format.

    \sa {installer::value}{installer.value}
    \sa setValue(), containsValue(), valueChanged()
*/
QString PackageManagerCore::value(const QString &key,
                                  const QString &defaultValue,
                                  const int &format) const {
  return d->m_data
      .value(key, defaultValue, static_cast<QSettings::Format>(format))
      .toString();
}
...
/*!
   ...
   a registry key.
    ...
    \sa value()
*/
QStringList PackageManagerCore::values(const QString &key,
                                       const QStringList &defaultValue) const {
  return d->m_data.value(key, defaultValue).toStringList();
}

/*!
    Returns the installer key for \a value. If \a value is not known, empty
   string is returned.
...
*/
QString PackageManagerCore::error() const { return d->m_error; }
...
bool PackageManagerCore::finishedWithSuccess() const {
  return d->m_status == PackageManagerCore::Success ||
         d->m_needToWriteMaintenanceTool;
}
...
/*!
    Replaces all variables within \a str by their respective values and returns
   the result.
*/
...
/*!
    \overload
    Replaces all variables within \a ba by their respective values and returns
   the result.
*/
...
*/
bool PackageManagerCore::isInstaller() const { return d->isInstaller(); }
...
*/
bool PackageManagerCore::isOfflineOnly() const { return d->isOfflineOnly(); }
...
*/
bool PackageManagerCore::isUninstaller() const { return d->isUninstaller(); }
...
*/
bool PackageManagerCore::isUpdater() const { return d->isUpdater(); }
...
/*!
    ...
    \sa
   {installer::isCommandLineDefaultInstall}{installer.isCommandLineDefaultInstall}
*/
...
*/
bool PackageManagerCore::runInstaller() { return d->runInstaller(); }
...
*/
bool PackageManagerCore::runUninstaller() { return d->runUninstaller(); }
...
*/
bool PackageManagerCore::runPackageUpdater() { return d->runPackageUpdater(); }
...
/*!
    Runs the installer, uninstaller, updater, package manager, or offline
   generator depending on the type of this binary. Returns \c true on success,
   otherwise \c false.
*/
...
bool PackageManagerCore::updateComponentData(struct Data &data,
                                             Component *component) {
  try {
    ...
    const QString packageTreeName =
        data.package->data(scTreeName).value<QPair<QString, bool>>().first;

    QString name = packageTreeName.isEmpty() ? packageName : packageTreeName;
    if (data.components->contains(name)) {
      qCritical() << "Cannot register component" << packageName << "with name"
                  << name << "! Component with identifier" << name
                  << "already exists.";
      // Conflicting original name, skip.
      ...
      if (!settings().allowUnstableComponents() ||
          data.components->contains(packageName))
        return false;

      qCDebug(lcInstallerInstallLog)
          << "Registering component with the original indetifier:"
          << packageName;
    ...
    name = packageName;
    if (settings().allowUnstableComponents()) {
      // Check if there are sha checksum mismatch. Component will still show in
      // install tree but is unselectable.
      foreach (const QString pkgName, d->m_metadataJob.shaMismatchPackages()) {
        if (pkgName == component->name()) {
          const QString errorString =
              QLatin1String("SHA mismatch detected for component ") + pkgName;
          d->m_pendingUnstableComponents.insert(
              component->name(), QPair<Component::UnstableError, QString>(
                                     Component::ShaMismatch, errorString));
        }
      }
    }
    ...
    const Repository repo =
        d->m_metadataJob.repositoryForCacheDirectory(localPath);
    if (repo.isValid()) {
    ...
    if (component->isFromOnlineRepository())
      component->addDownloadableArchives(
          data.package->data(scDownloadableArchives).toString());

    const QStringList componentsToReplace = QInstaller::splitStringWithComma(
        data.package->data(scReplaces).toString());
    if (!componentsToReplace.isEmpty()) {
      // Store the component (this is a component that replaces others) and all
      // components that this one will replace.
      data.replacementToExchangeables.insert(component, componentsToReplace);
    }

    if (isInstaller()) {
      // Running as installer means no component is installed, we do not need to
      // check if the replacement needs to be marked as installed, just return.
      return true;
    }

    if (data.installedPackages->contains(name)) {
      // The replacement is already installed, we can mark it as installed and
      // skip the search for a possible component to replace that might be
      // installed (to mark the replacement as installed).
      component->setInstalled();
      component->setValue(scInstalledVersion,
                          data.installedPackages->value(name).version);
      component->setValue(scLocalDependencies,
                          data.installedPackages->value(name).dependencies.join(
                              QLatin1String(",")));
      return true;
    }

    // The replacement is not yet installed, check all components to replace for
    // there install state.
    foreach (const QString &componentName, componentsToReplace) {
      if (data.installedPackages->contains(componentName)) {
        ...
        if (isUpdater()) {
          // Mark the replacement component as installed as well. Only do this
          // in updater mode, otherwise it would not show up in the updaters
          // component list.
          component->setInstalled();
          component->setValue(
              scInstalledVersion,
              data.installedPackages->value(componentName).version);
          break; // Break as soon as we know we found an installed component
                 // this one replaces.
        }
      }
    }
...
void PackageManagerCore::storeReplacedComponents(
    QHash<QString, Component *> &components, const struct Data &data,
    QMap<QString, QString> *const treeNameComponents) {
  QHash<Component *, QStringList>::const_iterator it =
      data.replacementToExchangeables.constBegin();
  ...
  for (; it != data.replacementToExchangeables.constEnd(); ++it) {
    foreach (const QString &componentName, it.value()) {
      ...
      if (!componentToReplace) {
        // If a component replaces another component which is not existing in
        // the installer binary or the installed component list, just ignore it.
        // This can happen when in installer mode and probably package manager
        // mode too.
        if (isUpdater())
          qCWarning(QInstaller::lcDeveloperBuild)
              << componentName
              << "- Does not exist in the repositories anymore.";
        continue;
      }
      ...
      if (!isUpdater() &&
          (isInstaller() || (it.key() && it.key()->isInstalled() &&
                             !componentToReplace->isInstalled()))) {
      ...
      d->componentsToReplace().insert(componentName,
                                      qMakePair(it.key(), componentToReplace));
      QStringList oldValue = d->componentReplaces().value(it.key()->name());
      d->componentReplaces().insert(it.key()->name(),
                                    oldValue << componentToReplace->name());
    }
  }
}

bool PackageManagerCore::fetchAllPackages(const PackagesList &remotes,
                                          const LocalPackagesMap &locals) {
  emit startAllComponentsReset();
  ...
  try {
    ...
    loadRemotePackages = [&](PackagesList *treeNamePackages,
                             bool firstRun) -> bool {
      foreach (Package *const package,
               (firstRun ? remotes : *treeNamePackages)) {
        if (d->statusCanceledOrFailed())
          return false;

        if (!ProductKeyCheck::instance()->isValidPackage(
                package->data(scName).toString()))
          continue;

        if (firstRun && !package->data(scTreeName)
                             .value<QPair<QString, bool>>()
                             .first.isEmpty()) {
          // Package has a tree name, leave for later
          treeNamePackages->append(package);
          continue;
        ...
        QScopedPointer<QInstaller::Component> remoteComponent(
            new QInstaller::Component(this));
        data.package = package;
        remoteComponent->loadDataFromPackage(*package);
        if (updateComponentData(data, remoteComponent.data())) {
          // Create a list where is name and treename. Repo can contain a
          // package with a different treename of component which is already
          // installed. We don't want to move already installed local packages.
    ...
    {
      // Loading remote package data is performed in two steps: first,
      // components without
      // - and then components with tree names. This is to ensure components
      // with tree names do not replace other components when registering fails
      // to a name conflict.
    ...
    foreach (auto &package, locals) {
      ...
      QScopedPointer<QInstaller::Component> localComponent(
          new QInstaller::Component(this));
      localComponent->loadDataFromPackage(package);
      const QString name = localComponent->treeName();

      // 1. Component has a treename in local but not in remote, add with local
      // treename
      if (!remoteTreeNameComponents.contains(localComponent->name()) &&
          !localComponent->value(scTreeName).isEmpty()) {
        delete allComponents.take(localComponent->name());
        // 2. Component has different treename in local and remote, add with
        // local treename
      } else if (remoteTreeNameComponents.contains(localComponent->name())) {
        const QString remoteTreeName =
            remoteTreeNameComponents.value(localComponent->name());
        const QString localTreeName = localComponent->value(scTreeName);
        if (remoteTreeName != localTreeName) {
          delete allComponents.take(
              remoteTreeNameComponents.value(localComponent->name()));
        } else {
          // 3. Component has same treename in local and remote, don't add the
          // component again.
          continue;
        }
        // 4. Component does not have treename in local or remote, don't add the
        // component again.
      } else if (allComponents.contains(localComponent->name())) {
        Component *const component =
            allComponents.value(localComponent->name());
        if (component->value(scTreeName).isEmpty() &&
            localComponent->value(scTreeName).isEmpty())
          continue;
      }
      // 5. Remote has treename for a different component that is already
      // reserved
      ...
      if (allComponents.contains(name)) {
        ...
        qCritical() << "Cannot register component"
                    << (key.isEmpty() ? name : key) << "with name" << name
                    << "! Component with identifier" << name
                    << "already exists.";
        ...
        if (!key.isEmpty() && !allComponents.contains(key) &&
            settings().allowUnstableComponents()) {
          qCDebug(lcInstallerInstallLog)
    ...
    // TODO: make sure we remove all message boxes inside the library at some
    // point.
    MessageBoxHandler::critical(MessageBoxHandler::currentBestSuitParent(),
...
bool PackageManagerCore::fetchUpdaterPackages(const PackagesList &remotes,
                                              const LocalPackagesMap &locals) {
  ...
  try {
    ...
    foreach (Package *const update, remotes) {
      ...
      if (updateComponentData(data, component.data())) {
        ...
        //            const QString isNew =
        //            update->data(scNewComponent).toString(); if
        //            (isNew.toLower() != scTrue)
        //                continue;
        ...
        if (!replaces.isEmpty()) {
          const QStringList possibleNames =
              replaces.split(QInstaller::commaRegExp(), Qt::SkipEmptyParts);
        ...
        // break if the update is not valid and if it's not the maintenance tool
        // (we might get an update for the maintenance tool even if it's not
        // currently installed - possible offline installation)
        if (!isValidUpdate &&
            (update->data(scEssential, scFalse).toString().toLower() ==
             scFalse))
    ...
    // store all components that got a replacement, but do not modify the
    // components list
    ...
    if (!components.isEmpty()) {
      ...
      // even for possible dependencies we need to load the scripts for example
      // to get archives
      ...
      foreach (QInstaller::Component *component, d->m_updaterComponentsDeps) {
        ...
        if (component->isInstalled()) {
          // since we do not put them into the model, which would force a update
          // of e.g. tri state components, we have to check all installed
...
/*!
    ...
    The \a treeNameComponents is a map of original component names and new tree
   names.
*/
void PackageManagerCore::createAutoTreeNames(
  ...
  while (i.hasNext()) {
    ...
    for (j = treeNameComponents.begin(); j != treeNameComponents.end(); ++j) {
      ...
      const Component *parent =
          components.value(treeNameComponents.value(name));
    ...
    const QString treeName =
        component->name().replace(newName, treeNameComponents.value(newName));

    if (components.contains(treeName) ||
        treeNameComponents.contains(treeName)) {
      // Can happen if the parent was moved to an existing identifier (which did
      // not have a component) and contains child that has a conflicting name
      // with a component in the existing branch.
      qCritical() << "Cannot register component" << component->name()
                  << "with automatic "
                     "tree name"
                  << treeName << "! Component with identifier" << treeName
                  << "already exists.";

      if (settings().allowUnstableComponents()) {
        qCDebug(lcInstallerInstallLog)
            << "Falling back to using the original indetifier:"
            << component->name();
...
void PackageManagerCore::restoreCheckState() { d->restoreCheckState(); }
...
void PackageManagerCore::updateDisplayVersions(const QString &displayKey) {
  ...
  foreach (const QString &key, keys) {
    ...
    if (componentsHash.value(key)->isInstalled()) {
      componentsHash.value(key)->setValue(
          scDisplayVersion,
          findDisplayVersion(key, componentsHash, scInstalledVersion, visited));
    }
    visited.clear();
    const QString displayVersionRemote =
        findDisplayVersion(key, componentsHash, scVersion, visited);
...
QString PackageManagerCore::findDisplayVersion(
    const QString &componentName, const QHash<QString, Component *> &components,
    const QString &versionKey, QHash<QString, bool> &visited) {
  if (!components.contains(componentName))
    return QString();
  const QString replaceWith =
      components.value(componentName)->value(scInheritVersion);
...
ComponentModel *
PackageManagerCore::componentModel(PackageManagerCore *core,
                                   const QString &objectName) const {
  ComponentModel *model =
      new ComponentModel(ComponentModelHelper::LastColumn, core);
  ...
  model->setHeaderData(ComponentModelHelper::InstalledVersionColumn,
                       Qt::Horizontal, ComponentModel::tr("Installed Version"));
  ...
  model->setHeaderData(ComponentModelHelper::UncompressedSizeColumn,
                       Qt::Horizontal, ComponentModel::tr("Size"));
...
*/
void PackageManagerCore::parseNameAndVersion(const QString &requirement,
