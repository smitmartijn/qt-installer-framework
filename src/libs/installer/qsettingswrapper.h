...
public:
  ...
  QSettingsWrapper(QSettings::Format format, Scope scope,
                   const QString &organization,
                   const QString &application = QString(), QObject *parent = 0);
  QSettingsWrapper(const QString &fileName, QSettings::Format format,
                   QObject *parent = 0);
  ~QSettingsWrapper();
...
private: // we cannot support the following functionality
  ...
  static void setPath(QSettings::Format /*format*/, Scope /*scope*/,
                      const QString & /*path*/);
  ...
  registerFormat(const QString &extension, ReadFunc readFunc,
                 WriteFunc writeFunc,
